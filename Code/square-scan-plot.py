...
fn = f"./Data/square_scan_a0.0_g50_size{size}_N{N}.h5"
...
plt.suptitle("SOR Convergence for Square Domain")
plt.tight_layout()
...
plt.savefig("./Images/square_scan_results.pdf", dpi=450)
plt.show()