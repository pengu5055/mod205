"""
Plot results circle-scan zoomed on the optimal alpha area.
"""
import h5py as h5
import numpy as np
...
fn = f"./Data/circle_scan_a{a_start}_g{n_points}_size{size}_N{N}.h5"
...
plt.suptitle("Zoomed-In SOR Convergence for Circle Domain")
plt.tight_layout()
...
plt.savefig("./Images/circle_scan_results_zoom.pdf", dpi=450)
plt.show()